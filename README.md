...
Three analytical result files were exported to HDFS: heatmap data, line-chart data, and street efficiency data.
These files were retrieved from HDFS and imported into Power BI.
